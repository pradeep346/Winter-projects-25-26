module layer(
    ...
    input  wire [15:0] bias_1,bias_2,bias_3,bias_4,bias_5,bias_6,bias_7,bias_8, // Note: Currently unused as biases are hardcoded below
    input  wire        last,       
    ...
    // Fixed: neuron5 now uses weight_n5
