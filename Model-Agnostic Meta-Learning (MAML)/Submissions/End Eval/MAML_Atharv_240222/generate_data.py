...
if __name__ == "__main__":
    ...
    # Paste your generate_channel_estimation_tasks code here
# then run:

np.random.seed(42)

train_tasks = generate_channel_estimation_tasks(100)
test_tasks = generate_channel_estimation_tasks(20)

np.savez_compressed("channel_data.npz", train=train_tasks, test=test_tasks)
